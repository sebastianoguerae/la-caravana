...
const DATA = {
  ...
  empresa: {
    ...
    // con certeza — buildMarcasHTML() cae a un chip de texto en ese caso.
    marcas: [
      { nombre: 'Starbucks', logo: 'starbucks.jpeg' },
      { nombre: 'DoubleTree by Hilton', logo: 'doubletree-by-hilton.jpg' },
      { nombre: 'Sofitel Bogotá Victoria Regia', logo: 'sofitel-bogota-victoria-regia.jpg' },
      { nombre: 'Hard Rock Cafe', logo: 'hard-rock-cafe.png' },
      { nombre: 'BMW', logo: 'bmw.png' },
      { nombre: 'Mercedes-Benz', logo: 'mercedes-benz.jpg' },
      { nombre: 'Coca-Cola', logo: 'coca-cola.jpg' },
      { nombre: 'Águila', logo: 'aguila.jpg' },
      { nombre: 'Éxito', logo: 'exito.png' },
      { nombre: 'Mango', logo: 'mango.png' },
      { nombre: 'Stradivarius', logo: 'stradivarius.png' },
      { nombre: 'Steve Madden', logo: 'steve-madden.png' },
      { nombre: 'Coach', logo: 'coach.png' },
      { nombre: 'Tiffany & Co.', logo: 'tiffany-and-co.png' },
      { nombre: 'Carolina Herrera', logo: 'carolina-herrera.jpg' },
      { nombre: 'Azulu', logo: 'azulu.png' },
      { nombre: "Kiehl's", logo: 'kiehls.png' },
      { nombre: 'Belcorp', logo: 'belcorp.jpg' },
      { nombre: 'MASGLO Belleza Profesional', logo: 'masglo-belleza-profesional.png' },
      { nombre: 'Blush-Bar', logo: 'blush-bar.png' },
      { nombre: 'LATAM Airlines', logo: 'latam-airlines.jpg' },
      { nombre: 'SeePuertoRico.com', logo: 'see-puerto-rico.png' },
      { nombre: 'Discovery Channel', logo: 'discovery-channel.png' },
      ...
      { nombre: 'Credicorp Capital', logo: 'credicorp-capital.jpg' },
      { nombre: 'SAP Business One', logo: 'sap-business-one.png' },
      { nombre: 'REM Construcciones', logo: 'rem-construcciones.jpeg' },
      { nombre: 'Prabyc Ingenieros', logo: 'prabyc-ingenieros.png' },
